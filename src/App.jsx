              ...
              <div className="flex-1">
                  ...
                  <div className="space-y-6 text-slate-300 leading-relaxed text-lg">
                    ...
                    <p>
                      ...
                      וזה בדיוק <strong>היתרון</strong> שלכם.
                    </p>
                    <p>
                      בזמן שאחרים נחים על זרי הדפנה, אני חוקר את כלי ה-<strong>AI</strong> החדשים ביותר ומוצא דרכים חדשניות להביא לידים.
                      אני לא עובד על "אוטומט". כל לקוח הוא פרויקט הדגל שלי.
                    </p>
                    <p>
                      אני יזם בנשמה. אני מבין שעסק צריך <strong>החזר השקעה (ROI)</strong> ולא רק "לייקים". אני כאן כדי לבנות איתכם מערכת שיווקית שעובדת.
                    </p>
