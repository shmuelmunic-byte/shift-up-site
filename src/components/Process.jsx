...
const FALLBACK_STEPS = [
  ...
  { title: 'האקשן',   description: 'קמפיין מוכן להרצה יוצא לדרך: מקים ומנהל את הקמפיינים ב-Meta וב-Google, מייצר קריאייטיב שמוכר — וחודש הניהול הראשון על אחריותי.', bullets: ['קמפיינים ב-Meta + Google', 'קריאייטיב שמוכר', 'הבטחת ביצוע על החודש הראשון'] },
];
