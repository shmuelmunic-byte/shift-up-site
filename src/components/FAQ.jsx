...
const faqs = [
  ...
  },
  {
    ...
    a: 'שניהם. אחרי שאנחנו סוגרים אסטרטגיה, אני בונה ומפעיל לך את הקמפיינים הממומנים ב-Meta וב-Google, בונה דפי נחיתה ומטמיע אוטומציות AI. אסטרטג ומבצע באותו אדם.',
  },
];
