...
const FALLBACK_FAQS = [
  ...
  { q: 'כמה זה עולה?', a: 'הקמה חד-פעמית 1,500–3,000 ₪ (לרוב סביב 2,250 ₪, לפי היקף) + ניהול חודשי 1,300–1,500 ₪, לא כולל תקציב מדיה. בלי חבילות מעורפלות — מחיר ברור לפני שמתחילים.' },
  ...
  { q: 'כבר נכוויתי מספק קודם. למה שהפעם יהיה שונה?', a: 'בגלל זה יש הבטחת ביצוע: חודש הניהול הראשון על אחריותי — אם הוא לא מביא פניות, אני ממשיך לעבוד בלי לגבות עד שזה עובד. הסיכון עליי, לא עליך.' },
