...
const FALLBACK_FAQS = [
  { q: 'כמה זמן לוקח לראות תוצאות?', a: 'הפיצוח עצמו לוקח כשבועיים. לראות לידים איכותיים זורמים — בין 30 ל-60 יום, תלוי בענף. אני בונה איתך לטווח ארוך, לא הבטחות סרק של "תוצאות בעוד שבוע".' },
  { q: 'אני עסק קטן, זה לא יקר לי מדי?', a: 'בדיוק לעסקים קטנים זה הכי קריטי. אתה לא יכול להרשות לעצמך לבזבז תקציב על מסרים לא נכונים. אני מתאים את ההיקף לכיס שלך, ופותחים בשיחה ללא עלות.' },
  { q: 'במה אתה שונה משאר משווקי הדיגיטל?', a: 'רובם מתחילים ב"בוא נריץ קמפיין". אני מתחיל ב"בוא נבין מה אנחנו מוכרים ולמי". בנוסף, אני משלב כלי AI שחוסכים זמן וכסף, ולוקח מספר מצומצם של לקוחות.' },
  { q: 'אתה מתאים לכל סוג של עסק?', a: 'אני עובד עם עסקים קטנים ובינוניים, גם B2B וגם B2C. עסקי שירות, מסחר, יזמים, חברות מבוססות. אם אני לא מרגיש שאני יכול להביא ערך אמיתי, אגיד לך כבר בשיחת ההיכרות, בלי בלבולי מוח.' },
  { q: 'מה כולל הפיצוח האסטרטגי?', a: 'מסמך אסטרטגי מלא: ניתוח מתחרים, מיפוי קהל יעד, הצעת ערך מדויקת, מסרים מרכזיים, ערוצי שיווק מומלצים, ומפת דרכים יישומית של 90 יום.' },
  { q: 'אתה גם מבצע או רק מייעץ?', a: 'שניהם. אחרי שאנחנו סוגרים אסטרטגיה, אני בונה ומפעיל לך את הקמפיינים הממומנים ב-Meta וב-Google, מטפל במסרים ובקריאייטיב, ומוצא פתרונות לאתגרים שיווקיים מיוחדים. אסטרטג ומבצע באותו אדם.' },
];
