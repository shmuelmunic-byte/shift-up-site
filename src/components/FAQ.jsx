...
const FALLBACK_FAQS = [
  { q: 'כמה זמן לוקח לראות תוצאות?', a: 'המחקר והאסטרטגיה לוקחים כשבועיים. לראות לידים איכותיים זורמים לוקח בין 30 ל-60 יום, תלוי בענף. אני בונה איתך לטווח ארוך, לא הבטחות סרק של "תוצאות בעוד שבוע".' },
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          border: `1px solid ${isActive ? 'oklch(0.785 0.173 156.6 / 0.3)' : 'oklch(0.22 0.02 240)'}`,
      ...
      >
        ...
        <span
          style={{
            ...
            width: 28, height: 28,
            borderRadius: '50%',
            background: isActive ? 'oklch(0.785 0.173 156.6 / 0.2)' : 'oklch(0.18 0.025 240)',
            display: 'flex',
            alignItems: 'center',
    ...
    >
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div className="faq-header" style={{ textAlign: 'right', marginBottom: 52, opacity: 0 }}>
          <div className="section-label">שאלות ותשובות</div>
          <h2
            style={{
