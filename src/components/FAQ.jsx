...
const faqs = [
  ...
  },
  {
    ...
    a: 'רובם מתחילים ב"בוא נריץ קמפיין". אני מתחיל ב"בוא נבין מה אנחנו מוכרים ולמי". בנוסף, אני משלב כלי AI שחוסכים זמן וכסף, ולוקח מספר מצומצם של לקוחות.',
  },
  {
    q: 'אתה מתאים לכל סוג של עסק?',
    a: 'אני עובד עם עסקים קטנים ובינוניים, גם B2B וגם B2C. עסקי שירות, מסחר, יזמים, חברות מבוססות. אם אני לא מרגיש שאני יכול להביא ערך אמיתי, אגיד לך כבר בשיחת ההיכרות, בלי בלבולי מוח.',
  },
  {
  ...
  },
  {
    ...
    a: 'שניהם. אחרי שאנחנו סוגרים אסטרטגיה, אני בונה ומפעיל לך את הקמפיינים הממומנים ב-Meta וב-Google, מטפל במסרים ובקריאייטיב, ומוצא פתרונות לאתגרים שיווקיים מיוחדים. אסטרטג ומבצע באותו אדם.',
  },
];
