...
function EnFooter() {
  const socials = [
    ...
    { label: 'Email',     href: 'mailto:shmuelmunic@gmail.com', emailClick: true, icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> },
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          {socials.map(s => (
            <a key={s.label} href={s.href} aria-label={s.label}
              ...
              onClick={s.emailClick ? handleEmailClick : undefined}
