...
select * from (values
  ('2–3 עסקים ברבעון', 'בוחר מעט לקוחות בכוונה — כדי שכל אחד יקבל ליווי מלא, לא תור.', 0),
  ('אדם אחד, לא סוכנות', 'מי שמפצח את האסטרטגיה הוא מי שמבצע אותה. בלי צוות מתחלף, בלי מתמחה.', 1),
  ('שיחת היכרות חינם', 'נבדוק יחד אם יש התאמה — בלי התחייבות, בלי לחץ מכירה.', 2)
...
insert into public.site_content (key, value, section, label, type) values
  ('trust.title',          'לא עובד עם כולם.',            'רצועת אמון', 'כותרת', 'text'),
  ('trust.title_accent',   'וזה בדיוק העניין.',          'רצועת אמון', 'כותרת — חלק ירוק', 'text'),
  ...
  ('proof.lead',           'קודם החשיבה — איך מפצחים מיצוב של עסק. אחר כך הביצוע — קריאייטיב אמיתי שיצרתי, בכל תחום ולכל קהל.', 'הוכחה', 'פסקת פתיחה', 'textarea'),
  ...
  ('leadform.scarcity',    'פנוי כרגע ל-2–3 עסקים בלבד ברבעון', 'טופס לידים', 'רצועת scarcity', 'text'),
  ...
  ('leadform.subtitle',    'השאר פרטים ואחזור אליך לשיחת פיצוח קצרה — נבדוק יחד אם יש התאמה.', 'טופס לידים', 'תת-כותרת', 'textarea'),
  ('leadform.price_note',  'מתחיל מ-1,500 ₪ · שיחת הפיצוח הראשונה חינם, ללא התחייבות.', 'טופס לידים', 'שורת מחיר', 'text'),
